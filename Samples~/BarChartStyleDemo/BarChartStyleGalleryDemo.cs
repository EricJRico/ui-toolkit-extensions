...
{
    /// <summary>
    /// Game-themed style gallery showcasing four distinct visual themes.
    ///
    /// Scene setup
    /// ────────────
    ...
    [AddComponentMenu("UI Toolkit/Bar Graph Style Gallery Demo")]
    public sealed class BarChartStyleGalleryDemo : MonoBehaviour
    {
        [Header("Demo Options")]
        [SerializeField] private bool _showEventLog = true;

        private UIDocument _doc;
        private readonly List<StyleDemoPanel> _panels = new List<StyleDemoPanel>();
        ...
        private void BuildUI()
        {
            ...
            titleRow.Add(new Label("BarGraph Toolkit \u2014 Game Style Demo")
            {
                style =
                {
                    fontSize               = 16,
        ...
        private void WireEvents(StyleDemoPanel panel)
        {
